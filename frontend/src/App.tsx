...
export default function App() {
  const { imageSrc, metrics, connected, sendFrame, waking } = useStreamSocket() as any;
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className={`connection-badge ${connected ? "on" : "off"}`}>
          {connected ? "WS Connected" : waking ? "Waking backend…" : "WS Reconnecting…"}
        </div>
      </header>
        ...
        <div className="main-stage">
          ...
          <aside className="sidebar">
            ...
            <div className="info-card">
              <h3>How it works</h3>
              <ol>
                <li>Webcam capture occurs in your browser via getUserMedia().</li>
                <li>Frames are sent to the backend over WebSocket.</li>
                <li>YOLO detects persons (class 0) and ByteTrack assigns IDs.</li>
                <li>Annotated frames and counts are returned and displayed.</li>
              </ol>
            </div>
          </aside>
        </div>
